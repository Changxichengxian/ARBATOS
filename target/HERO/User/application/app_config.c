...
app_config_t g_app_config = {
    ...
    .shoot =
        {
            .fric_speed_up_rpm = 4500.0f,      // [112] 摩擦轮高速目标转速（RPM，需按弹速整定）
            .fric_speed_down_rpm = 4000.0f,    // [113] 摩擦轮低速目标转速（RPM）
            ...
            .fric_motor_dir = {-1, 1, 1, -1},    // [122]0x201 [123]0x202 [124]0x203 [125]0x204 | 四路摩擦轮方向（按实际安装可改为 1/-1/0）
    ...
    .test =
        {
            .mode = TEST_MODE_NONE, // [244] 测试模式（UART1 发送 244:<value>）
