...
/*
 * INFANTRY/A-board keeps USART1 for SBUS.
 * Reuse the legacy "UART1" tuning / ELRS / image-link API on UART8 instead.
 */
#define BSP_AUX_UART_HANDLE huart8

extern UART_HandleTypeDef huart8;
extern UART_HandleTypeDef huart6;

static bsp_uart1_rx_event_cb_t g_aux_rx_event_cb = NULL;
static bsp_uart1_rx_byte_cb_t g_aux_rx_byte_cb = NULL;
static bsp_uart1_error_cb_t g_aux_error_cb = NULL;
