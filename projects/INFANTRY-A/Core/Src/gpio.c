...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, MPU6500_CS_Pin|LED_G_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin : IST8310_INT_Pin */
  GPIO_InitStruct.Pin = IST8310_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(IST8310_INT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : IST8310_RST_Pin LED_R_Pin */
  GPIO_InitStruct.Pin = IST8310_RST_Pin|LED_R_Pin;
  ...
  /*Configure GPIO pin : SD_EXTI_Pin */
