...
typedef struct
{
    ...
    ChassisMotor motor_chassis[4];
    PidTypeDef motor_speed_pid[4];
    PidTypeDef ChassisAnglePid;

    first_order_filter_type_t ChassisCmdSlowSetVx;
    first_order_filter_type_t ChassisCmdSlowSetVy;
    fp32 vx;
    fp32 vy;
    fp32 wz;
    fp32 vx_set;
    ...
    fp32 ChassisPitch;
    fp32 ChassisRoll;
    ChassisControlSnapshot fast;
} ChassisMove;

extern void ChassisControlTask(void const *pvParameters);
extern void ChassisRcToControlVector(fp32 *vx_set, fp32 *vy_set, ChassisMove *ChassisMoveRcToVector);
extern const ChassisMove *get_chassis_move_point(void);

extern void ChassisTuneGetFollowPid(PidParam *out);
extern void ChassisTuneSetFollowPid(const PidParam *pid, bool_t clear_state);
extern void ChassisTuneClearFollowPid(void);
extern void ChassisTuneGetMotorSpeedPid(PidParam *out);
extern void ChassisTuneSetMotorSpeedPid(const PidParam *pid, bool_t clear_state);
