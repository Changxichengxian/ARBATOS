...
{
    actuator_cmd_set_chassis_current(index, current);
}

int16_t actuator_cmd_get_chassis_current_can1(uint8_t index)
{
    return actuator_cmd_get_chassis_current(index);
}
