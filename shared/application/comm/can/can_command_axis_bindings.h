...
#define CAN_TX_AXIS_CHASSIS0_NODE() motor_instance_node(CAN_TX_AXIS_CHASSIS0_ACTUATOR_ID)
...
#define CAN_TX_AXIS_CHASSIS1_NODE() motor_instance_node(CAN_TX_AXIS_CHASSIS1_ACTUATOR_ID)
...
#define CAN_TX_AXIS_CHASSIS2_NODE() motor_instance_node(CAN_TX_AXIS_CHASSIS2_ACTUATOR_ID)
...
#define CAN_TX_AXIS_CHASSIS3_NODE() motor_instance_node(CAN_TX_AXIS_CHASSIS3_ACTUATOR_ID)
...
#define CAN_TX_AXIS_YAW_NODE() motor_instance_node(CAN_TX_AXIS_YAW_ACTUATOR_ID)
...
#define CAN_TX_AXIS_YAW_UPPER_NODE() motor_instance_node(CAN_TX_AXIS_YAW_UPPER_ACTUATOR_ID)
...
#define CAN_TX_AXIS_PITCH_NODE() motor_instance_node(CAN_TX_AXIS_PITCH_ACTUATOR_ID)
...
#define CAN_TX_AXIS_TRIGGER_NODE() motor_instance_node(CAN_TX_AXIS_TRIGGER_ACTUATOR_ID)
...
#define CAN_TX_AXIS_FRICTION0_NODE() motor_instance_node(CAN_TX_AXIS_FRICTION0_ACTUATOR_ID)
...
#define CAN_TX_AXIS_FRICTION1_NODE() motor_instance_node(CAN_TX_AXIS_FRICTION1_ACTUATOR_ID)
...
#define CAN_TX_AXIS_FRICTION2_NODE() motor_instance_node(CAN_TX_AXIS_FRICTION2_ACTUATOR_ID)
...
#define CAN_TX_AXIS_FRICTION3_NODE() motor_instance_node(CAN_TX_AXIS_FRICTION3_ACTUATOR_ID)
...
#define CAN_TX_AXIS_ARM_ACTUATOR_ID(index_) actuator_id_from_range(ACTUATOR_ID_ARM_J0, (index_), MOTOR_ARM_JOINT_COUNT)
#define CAN_TX_AXIS_ARM_NODE(index_) motor_instance_node(CAN_TX_AXIS_ARM_ACTUATOR_ID((index_)))
