...
typedef struct
{
    const motor_measure_t *GimbalMotorMeasure;
    GimbalPid GimbalMotorAnglePid;
    PidTypeDef GimbalMotorGyroPid;
    GimbalMotorMode mode;
    GimbalMotorMode last_mode;
    uint16_t offset_ecd;
    fp32 max_angle;
    fp32 min_angle;
...
typedef struct
{
    ...
    GimbalMotor GimbalPitchMotor;
    GimbalStepCali GimbalCali;
...
extern void GimbalTuneGetYawSpeedPid(PidParam *out);
extern void GimbalTuneGetYawAnglePid(PidParam *out);
extern void GimbalTuneSetYawSpeedPid(const PidParam *pid, bool_t clear_state);
extern void GimbalTuneSetYawAnglePid(const PidParam *pid, bool_t clear_state);
extern void GimbalTuneClearYawPid(void);

extern void GimbalTuneGetPitchSpeedPid(PidParam *out);
extern void GimbalTuneGetPitchAnglePid(PidParam *out);
extern void GimbalTuneSetPitchSpeedPid(const PidParam *pid, bool_t clear_state);
extern void GimbalTuneSetPitchAnglePid(const PidParam *pid, bool_t clear_state);
extern void GimbalTuneClearPitchPid(void);
...
extern volatile int16_t GimbalWatchYawCurrent;
extern volatile int16_t GimbalWatchYawUpperCurrent;
extern volatile int16_t GimbalWatchPitchCurrent;
extern volatile int16_t GimbalYawEasytestCurrent;
