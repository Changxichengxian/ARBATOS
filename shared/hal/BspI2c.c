...
void BspI2cMasterTransmit(I2C_TypeDef *I2C, uint16_t I2C_address, uint8_t *data, uint16_t len)
{
    if(I2C == I2C1)
    {
...
void BspI2cReset(I2C_TypeDef *I2C)
{
...
bool_t BspI2cCheckAck(I2C_TypeDef *I2C, uint16_t I2C_address)
{
    I2C_HandleTypeDef *hi2c;
    if(I2C == I2C1)
    {
